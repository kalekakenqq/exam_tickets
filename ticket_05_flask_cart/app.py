...
<html lang="ru">
<head><meta charset="UTF-8"><title>Магазин</title>""" + _STYLE + """</head>
<body>
<nav>
    <a href="/">Каталог</a>
...
<html lang="ru">
<head><meta charset="UTF-8"><title>Корзина</title>""" + _STYLE + """</head>
<body>
<nav>
    <a href="/">Каталог</a>
...
def index():
    ...
    return render_template_string(INDEX_TEMPLATE, catalog=catalog, cart_count=len(cart_ids))
